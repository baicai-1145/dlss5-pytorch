...
def comb_f23():
    ...
    return out
for g in [("enc01",("enc01",)), ("enc234",("enc234",)), ("bn",("bn",)), ("dec",("dec",)), ("expands",("expands",)),
          ("enc234+bn",("enc234","bn")), ("enc01+enc234+bn",("enc01","enc234","bn"))]:
    SEL["groups"] = g[1]
    c16 = clean16(); f2, f3 = comb_f23()
    print(f"W1@{g[0]:16s}: clean16={c16:+.4f} f2={f2:+.4f} f3={f3:+.4f}", flush=True)
